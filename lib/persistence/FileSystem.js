...
var DEFAULT_STORAGE_DIRECTORY = process.pwd() + '/.sonic_db
...
FileSystem.prototype.scheduleJob = function(jobName, schedule, callback) {
  var self = this
...
FileSystem.prototype._registerNewSchedule = function(jobName, schedule, callback) {
  var self = this
...
FileSystem.prototype._registerNewScheduleUnsafe = function(jobName, callback) {
  var self = this
...
FileSystem.prototype._registerNewJobName = function(jobName, callback) {
  var self = this
  lock(this._jobMappingFilePath, function(err) {
    if(err) {
      return callback(err)
...
FileSystem.prototype._registerNewJobNameUnsafe = function(jobName, callback) {
  var self = this
  fs.readFile(this._jobMappingFilePath, function(err, content) {
    var jobs = {}
    try {
